    ...
    "footer_icons": [
        {
            ...
            "html": (
                ...
                "958.288 1.243.294.26.006.549-.1.868-.32 2.379-1.471 3.304-2.214 3.374-2.23.0"
                "5-.012.32-.026.166.016.047.041.042.32.037.141-.03.129-1.227 1.241-1.846 1.81"
        ...
        {  # Github logo
            ...
            "html": (
                ...
                "0-.87.31-1.59.82-2.35-.08-.2-.36-1.02.08-2.32 0 0 .67-.21 2.2.82.64-.18 1.32-.2"
                "7 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.32.5"
                "1.56.82 1.27.82 2.35 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 "
        ...
        {  # PTB website logo - globe
            ...
            "html": (
                ...
                "3.05c.362.384.763.349 1.198.49zM3.509 7.5c.036-1.07.188-2.087.436-3.008a9.124 "
